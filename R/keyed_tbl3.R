...
# TODO try with (decorator_df, [grouped_df,] [tbl_df, tbl,] df) class, with decorator_df having a nested attr structure to hold the decorator stack? or perhaps class (top_of_stack, decorator_df, [grouped_df,] [tbl_df, tbl,] df)?  but with either of these, have to manually forward ALL S3 methods, since it breaks S3 for the inner ones, and would miss any 3rd-party ones...
