...
toy_tbl1 <- tibble(k = c(1,1,1,2,2), t = c(1:3,1:2), v = 1:5)
...
toy1_ktbl1 <- new_keyed_tibble1(toy_tbl1, c("k", "t"))
toy1_ktbl2 <- new_keyed_df2(toy_tbl1, c("k", "t"))
toy1_ktbl4 <- new_keyed_df4(toy_tbl1, c("k", "t"))
toy1_tsbl <- tsibble::as_tsibble(toy_tbl1, key = k, index = t)
